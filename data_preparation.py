...
input_dir = './datasets/CVUSA/bingmap/19/'
output_dir = './datasets/CVUSA/polarmap/19/'
...
input_dir = './datasets/CVACT/ANU_data_test/satview_polish/'
output_dir = './datasets/CVACT/ANU_data_test/polarmap/'
...
input_dir = './datasets/CVACT/ANU_data_test/streetview/'
output_dir = './datasets/CVACT/ANU_data_test/streetview_processed/'
